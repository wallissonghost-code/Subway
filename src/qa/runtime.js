import{getRunnerSnapshot,runnerActions,setQACollisionBypass}from'../game/runner.js';
import{getNearby,getSceneMetrics,stageObstacleForQA}from'../game/scene.js';
...
window.__RAIL_QA__={snapshot,action(name){const fn=runnerActions[name];return typeof fn==='function'?!!fn():false},setCollisionBypass(value){return setQACollisionBypass(value)},stageCollision(opts){return stageObstacleForQA(opts)},version:'qa-v2'};
